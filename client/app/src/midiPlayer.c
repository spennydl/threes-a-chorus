...
static void
parse_and_dump(struct midi_parser* parser, int channel, long long* trackLengths)
{
    clearAllEventNodes();
    ...
    while (1) {
        ...
        switch (status) {
            ...
            case MIDI_PARSER_HEADER:
                ...
                // TODO: Make it so if the channel length is 0 then  we don't
                // play with it Probably later on and not in this function
